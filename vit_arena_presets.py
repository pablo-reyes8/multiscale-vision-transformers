...
AUGMENT_PRESETS = {
    "matched": "RandomCrop(32,pad=4) + HorizontalFlip + RandAugment + CIFAR-100 normalization.",
    "basic": "RandomCrop(32,pad=4) + HorizontalFlip + CIFAR-100 normalization.",
    "none": "No train-time augmentation, only CIFAR-100 normalization.",
